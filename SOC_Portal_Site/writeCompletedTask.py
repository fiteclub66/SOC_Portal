...
def handleCompTask(uID, tID, cN, tN, csID, sD, eD, fT, f, totT, stat, SLA, spN, c, sT, r):
    ...
    taskData = (rT.taskID, rT.clientName, rT.taskName, rT.catSkillID, uID, rT.startDate, rT.endDate, rT.freqType, rT.frequency, rT.totalTime, rT.status, rT.SLA, rT.specialNotes, rT.counter, rT.subTask, rea)
...
def handleExpiredTask(uID, tID, cN, tN, csID, sD, eD, fT, f, totT, stat, SLA, spN, c, sT, r):
    db = mysql.connector.connect(user='root', password='MyR00t1423!',
                              host='10.0.51.21',
                              database='SOC_Portal')
